...
@section('contenido')
    ...
    <form action="/dashboard/users" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="rut" name="rut" required oninput="checkRut(this)" placeholder="11111111-1"
...
@section('script')
    <script>
        function checkRut(rut) {
            ...
            if (dvEsperado != dv) {
                rut.setCustomValidity("El dígito verificador no coincide con el rut.");
                return false;
            }
